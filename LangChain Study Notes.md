...
3. **Modular Design**
    ![Composability allowing variety of LLMs](./images/LangChainStudyNotes-Composability.png)
...
5. **Agents**
    ![Agent Example](./images/LangChainStudyNotes-AgentExample.png)
...
## Ecosystem
![LangChain Ecosystem](./images/LangChain-Stack---split---V3.png)
